# Changelog
This is the changelog for casual java, it includes the tag, commit date, commit message, and full commit message for each tag in the project's history.

## [3.3.1] - 2025-01-13
- **Commit Message:** Feature/3.2/unmarshall all null values (#143)
- **Full Commit Message:**
  ```
...
## [3.3.0] - 2024-12-10
- **Commit Message:** Feature/3.2/code needed for conversation support in casual caller (#141)
- **Full Commit Message:**
  ```
...
## [3.2.50] - 2024-12-10
- **Commit Message:** Feature/3.2/initialise fieled on startup (#140)
- **Full Commit Message:**
  ```
...
## [3.2.49] - 2024-12-09
- **Commit Message:** Feature/3.2/bundle gson (#138)
- **Full Commit Message:**
  ```
...
## [3.2.48] - 2024-11-28
- **Commit Message:** Bugfix/3.2/inbound discovery with custom service handlers (#130)
- **Full Commit Message:**
  ```
...
## [3.2.47] - 2024-11-21
- **Commit Message:** Bugfix/3.2/configuration mode not honoured (#126)
- **Full Commit Message:**
  ```
...
## [3.2.46] - 2024-11-01
- **Commit Message:** trid unique per resource, not global (#127)
- **Full Commit Message:**
  ```
...
## [3.2.45] - 2024-10-07
- **Commit Message:** Feature/3.2/java 17 sonar fixes (#123)
- **Full Commit Message:**
  ```
Java 17 sonar fixes.
...
## [3.2.44] - 2024-09-27
- **Commit Message:** Feature/3.2/execution sticky (#122)
- **Full Commit Message:**
  ```
...
## [3.2.43] - 2024-09-09
- **Commit Message:** bugfix/3.2/reverse inbound make sure inet address is not resolved and cached
- **Full Commit Message:**
  ```
...
## [3.2.42] - 2024-06-12
- **Commit Message:** Feature/3.2/reverse inbound share event loop group (#118) (#119)
- **Full Commit Message:**
  ```
...
## [3.2.41] - 2024-05-15
- **Commit Message:** feature/3.2/event client do not set json object limit (#116)
- **Full Commit Message:**
  ```
* no user limit
...
## [3.2.40] - 2024-05-15
- **Commit Message:** bugfix/event client receives close in shutdown inside jvm (#115)
- **Full Commit Message:**
  ```
...
## [3.2.39] - 2024-05-08
- **Commit Message:** Feature/3.2/casual test (#114)
- **Full Commit Message:**
  ```
...
## [3.2.38] - 2024-05-02
- **Commit Message:** allow real, optional, method as well (#112)
- **Full Commit Message:**
  ```
...
## [3.2.37] - 2024-05-02
- **Commit Message:** Bugfix/3.2/log tool handle all messages (#111)
- **Full Commit Message:**
  ```
...
## [3.2.36] - 2024-04-23
- **Commit Message:** Feature/3.2/event client (#108)
- **Full Commit Message:**
  ```
...
## [3.2.35] - 2024-04-16
- **Commit Message:** reverse-inbound: connection backoff
- **Full Commit Message:**
  ```
...
## [3.2.34] - 2024-04-15
- **Commit Message:** Feature/3.2/event service testability (#105)
- **Full Commit Message:**
  ```
...
## [3.2.33] - 2024-03-28
- **Commit Message:** Feature/3.2/sphinx docs (#103)
- **Full Commit Message:**
  ```
...
## [3.2.32] - 2024-03-19
- **Commit Message:** feature/3.2/metric events (#99)
- **Full Commit Message:**
  ```
...
## [3.2.31] - 2024-03-01
- **Commit Message:** do not run prepare, commit, rollback on netty threads (#97)
- **Full Commit Message:**
  ```
...
## [3.2.30] - 2024-02-06
- **Commit Message:** bugfix/3.2/reverse-inbound-use-own-worker-group
- **Full Commit Message:**
  ```
...
## [3.2.29] - 2024-01-30
- **Commit Message:** feature/3.2/logging
- **Full Commit Message:**
  ```
...
## [3.2.27] - 2023-11-16
- **Commit Message:** Buggfix/3.2/honour tpnoreply
- **Full Commit Message:**
  ```
...
## [3.2.26] - 2023-10-19
- **Commit Message:** buggfix/3.2/pass real method to buffer handlers (#81)
- **Full Commit Message:**
  ```
...
## [3.2.25] - 2023-08-31
- **Commit Message:** Feature/3.2/topology update
- **Full Commit Message:**
  ```
...
## [3.2.24] - 2023-06-12
- **Commit Message:** feature/3.2/casual protocol 1.1 outbound (#76) (#77)
- **Full Commit Message:**
  ```
...
## [3.2.23] - 2023-05-17
- **Commit Message:** Feature/3.2/inbound log waiting for service registration
- **Full Commit Message:**
  ```
...
## [3.2.22] - 2023-04-06
- **Commit Message:** name change of SPI Extension file (#67)
- **Full Commit Message:**
  ```
...
## [3.2.21] - 2023-04-05
- **Commit Message:** netty bump to 4.1.91.Final
- **Full Commit Message:**
  ```
...
## [3.2.20] - 2023-04-05
- **Commit Message:** missed comments
- **Full Commit Message:**
  ```
...
## [3.2.19] - 2023-04-05
- **Commit Message:** Jakarta EE note
- **Full Commit Message:**
  ```
...
## [2.2.34] - 2024-10-09
- **Commit Message:** Feature/2.2/execution sticky (#124)
- **Full Commit Message:**
  ```
In the service call API, expose methods, tp(a)call, that additionally accepts a execution id.
...
## [2.2.33] - 2024-09-10
- **Commit Message:** Let netty handle DNS-resolution (#121)
- **Full Commit Message:**
  ```
This fixes a bug where we would cache a resolved InetSocketAddress.
...
## [2.2.32] - 2024-06-12
- **Commit Message:** Feature/2.2/reverse inbound share event loop group (#118)
- **Full Commit Message:**
  ```
* All reverse inbound clients now shares the same event loop group instead of creating a new per connection
   This works the same way as it currently does for outbound connections.
...
## [2.2.31] - 2024-05-06
- **Commit Message:** allow real optional method as well (#113)
- **Full Commit Message:**
  ```
allow real optional method as well
  ```
...
## [2.2.30] - 2024-04-19
- **Commit Message:** Bugfix/2.2/log tool handle all messages (#109)
- **Full Commit Message:**
  ```
* handle all message types and test that we do
  ```
...
## [2.2.28] - 2024-03-04
- **Commit Message:** do not run prepare, commit, rollback on netty threads (#97) (#98)
- **Full Commit Message:**
  ```
Reverse inbound is in fact a client and as such we do not want prepare/commit/rollback to run on any of nettys networking threads.
This is especially true since in fact an inbound prepare can result in an oubound prepare call via CasualXAResource, that then blocks that thread until an answer is received.
...
## [2.2.27] - 2024-02-06
- **Commit Message:** bugfix/2.2/reverse-inbound-use-own-worker-group
- **Full Commit Message:**
  ```
...
## [2.2.26] - 2024-02-06
- **Commit Message:** feature/3.2/logging (#90)
- **Full Commit Message:**
  ```
* Log all available information in inbound message listener
* Enable setting the netty log handler level for outbound/inbound and reverse inbound
...
## [2.2.25] - 2023-11-16
- **Commit Message:** Buggfix/2.2/honour tpnoreply (#83)
- **Full Commit Message:**
  ```
A non transactional tpacall with flags TPNOREPLY should never return nor expect an answer
  ```
...
## [2.2.24] - 2023-10-19
- **Commit Message:** buggfix/2.2/pass real method to buffer handlers (#82)
- **Full Commit Message:**
  ```
* The real method needs to be available for buffer handlers since annotations may only exist there and not on the proxy method.
We also future proof the API by using a wrapper class for the inbound request info that can be further expanded upon when need be.
...
## [2.2.23] - 2023-08-31
- **Commit Message:** Feature/2.2/topology update
- **Full Commit Message:**
  ```
Bump and support protocol version 1.2
It adds a topology updated event that we expose via CasualConnection.
...
## [2.2.22] - 2023-06-12
- **Commit Message:** Feature/2.2/casual protocol 1.1 outbound (#76)
- **Full Commit Message:**
  ```
Handle domain disconnect request by casual.
Note, this is for outbound connections only.
...
## [2.2.21] - 2023-05-17
- **Commit Message:** Feature/2.2/inbound log waiting for service registration
- **Full Commit Message:**
  ```
If the inbound startup mode is discovery, log the initial set of services and keep logging which service registrations that inbound is still waiting for.
This is due to a demand from a customer and it is not an unreasonable request.
...
## [2.2.19] - 2023-04-04
- **Commit Message:** casual caller external (#66)
- **Full Commit Message:**
  ```
...
## [2.2.18] - 2023-03-28
- **Commit Message:** wls needs Stateless annotation (#65)
- **Full Commit Message:**
  ```
...
## [2.2.17] - 2023-03-24
- **Commit Message:** Feature/make casual service handler extensible (#63)
- **Full Commit Message:**
  ```
...
## [2.2.16] - 2023-03-08
- **Commit Message:** Feature/maven central publishing#17 (#62)
- **Full Commit Message:**
  ```
...
## [2.2.15] - 2023-02-07
- **Commit Message:** Feature/stop jndi search timer if trigger mode and inbound started (#61)
- **Full Commit Message:**
  ```
...
## [2.2.14] - 2023-02-01
- **Commit Message:** Feature/casual xa is same rm (#60)
- **Full Commit Message:**
  ```
...
## [2.2.13] - 2023-01-18
- **Commit Message:** Feature/discovery request names sorted and unique (#56)
- **Full Commit Message:**
  ```
...
## [2.2.12] - 2023-01-13
- **Commit Message:** Reduce logging from WARN to FINEST when jndi lookup fails - add exception stack. (#55)
- **Full Commit Message:**
  ```
...
## [2.2.11] - 2023-01-11
- **Commit Message:** Feature/optional inbound delay start of server (#53)
- **Full Commit Message:**
  ```
...
## [2.2.10] - 2022-12-16
- **Commit Message:** log start inbound exception as SEVERE (#52)
- **Full Commit Message:**
  ```
...
## [2.2.9] - 2022-11-28
- **Commit Message:** Feature/more logging (#50)
- **Full Commit Message:**
  ```
...
## [2.2.8] - 2022-11-16
- **Commit Message:** finest instead of info logging (#47)
- **Full Commit Message:**
  ```
...
## [2.2.7] - 2022-10-26
- **Commit Message:** Feature/inbound epoll (#43)
- **Full Commit Message:**
  ```
...
## [2.2.6] - 2022-10-25
- **Commit Message:** Feature/reverse inbound (#42)
- **Full Commit Message:**
  ```
...
## [2.2.5] - 2022-10-19
- **Commit Message:** Feature/jdk 8 11 17 (#39)
- **Full Commit Message:**
  ```
...
## [2.2.4] - 2022-10-14
- **Commit Message:** Feature/netty epoll (#38)
- **Full Commit Message:**
  ```
...
## [2.2.3] - 2022-10-12
- **Commit Message:** Feature/revert domain id (#37)
- **Full Commit Message:**
  ```
...
## [2.2.2] - 2022-10-10
- **Commit Message:** Feature/network pooling (#36)
- **Full Commit Message:**
  ```
...
## [2.1.3] - 2022-09-20
- **Commit Message:** Feature/pooling backed by randomness (#34)
- **Full Commit Message:**
  ```
...
## [2.0.2] - 2022-07-29
- **Commit Message:** expose casual domain id and connection gone
- **Full Commit Message:**
  ```
...
## [2.0.1] - 2022-06-16
- **Commit Message:** Reduce log level from WARNING to FINEST (#30)
- **Full Commit Message:**
  ```
...
## [2.0.0] - 2022-06-08
- **Commit Message:** no optional parameter (#27)
- **Full Commit Message:**
  ```
...
## [1.2.1] - 2022-06-02
- **Commit Message:** Feature/gradle upgrade (#26)
- **Full Commit Message:**
  ```
...
## [1.2.0] - 2022-05-09
- **Commit Message:** Feature/test app (#23)
- **Full Commit Message:**
  ```
...
## [1.1.0] - 2022-05-08
- **Commit Message:** Feature/casual caller needs to handle connection reestablished better (#21)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Feature/more network logging (#7)
- **Full Commit Message:**
  ```
...
- **Commit Message:** always just close channel (#6)
- **Full Commit Message:**
  ```
...
- **Commit Message:** outbound network, only close channel if open
- **Full Commit Message:**
  ```
...
- **Commit Message:** Feature/fielded optional allow null fill with default values (#2)
- **Full Commit Message:**
  ```
FieldedTypeBuffer:
...
- **Commit Message:** feature/conversation (pull request #142)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/messages-v1.1-v1.2 (pull request #141)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/inbound-startup-mode-empty-should-default-not-fail (pull request #140)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/pretty-printer-branch-can-be-null-on-wls (pull request #139)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/marshalling-refactoring (pull request #136)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/config-use-env-var-if-config-is-missing (pull request #135)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/marshalling-missing-features (pull request #134)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/unmanaged-option (pull request #133)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/use-serviceloader-on-demand (pull request #132)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/marshalling-no-objenesis-dep (pull request #131)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/marshalling-via-spi (pull request #127)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/xid-and-execution-id-casual-pretty-printing (pull request #126)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/conversation-messages-latest
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/network-handle-io-error
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/no-queue-space
- **Full Commit Message:**
  ```
* no qspace
...
- **Commit Message:** Casual caller next generation
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/outbound-use-jee-concurrency-utils (pull request #120)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/service-handler-logging (pull request #119)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/jndi-util-log-do-not-throw (pull request #117)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/jndi-util-missing-unit-tests (pull request #116)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/configurable-domain-name (pull request #115)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/transactiontype-branch (pull request #114)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/missing-test-and-more-logging (pull request #113)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/cstringbuffer-should-always-be-serializable (pull request #110)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/version-bumps (pull request #108)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/optional-delay-startup-inbound (pull request #107)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/keep-outbound-definitions-in-ra-xml (pull request #105)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/wls-xml-no-outbound-config (pull request #104)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/inbound-server-keep-alive-on-child-handler (pull request #103)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/inbound-keep-alive (pull request #102)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/xa-resource-recover-return-empty-list (pull request #101)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/cleanup-xa-resource (pull request #100)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/honour-timeout-set (pull request #99)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Feature/handle casual disconnect
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/casual-inbound-handler-api-addition (pull request #97)
- **Full Commit Message:**
  ```
api addition
...
- **Commit Message:** Merged in feature/proper-env-var (pull request #96)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/multiple-ejbs-same-signiture (pull request #95)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/package-netty-in-rar (pull request #94)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/fixes-after-sonatype-gradle-scan (pull request #92)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/fielded-char (pull request #91)
- **Full Commit Message:**
  ```
fielded char
...
- **Commit Message:** Merged in feature/ra-xml (pull request #90)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/service-buffer-only-one-disallowed-case (pull request #89)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/netty-flags-as-env-not-java-properties (pull request #88)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/missing-transaction-enum-value (pull request #87)
- **Full Commit Message:**
  ```
missing enum value
...
- **Commit Message:** Merged in buggfix/casual-c-string (pull request #86)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/cstringbuffer-charset-be-explicit (pull request #85)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/cstring-nulltermination-validation (pull request #84)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/use-https-for-spring--bump-spock-version (pull request #83)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/casual-connection-wrap-exceptions (pull request #82)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/bufferhander-expose-servicecallinfo (pull request #81)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/jdk-11 (pull request #80)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/documentation (pull request #79)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/cleanup (pull request #78)
- **Full Commit Message:**
  ```
Sonar Cleanup
...
- **Commit Message:** feature/handle-network-gone (pull request #77)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/network-no-invalidation (pull request #76)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/service-buffer-can-be-empty (pull request #75)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/allow-empty-payload-in-service-call-reply (pull request #74)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/casual-api-javadoc (pull request #73)
- **Full Commit Message:**
  ```
casual-api javadoc
...
- **Commit Message:** deployment documentation
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in bugfix/resource_adapter_selection_inbound_mdb (pull request #71)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in bugfix/field_data_serialization (pull request #70)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in bugfix/inbound_marshalling (pull request #69)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/deployment_issue_wildfly13 (pull request #68)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/simplify-deployment (pull request #67)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/dequeue-expose-blocking (pull request #66)
- **Full Commit Message:**
  ```
...
- **Commit Message:** feature/inbound-passthrough-response (pull request #65)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/fielded-buffer-ok-empty (pull request #64)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in buggfix/fielded-use-env (pull request #63)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/cstring-buffer (pull request #60)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/casual-buffer-default-pass-through (pull request #62)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/lookup-exception-to-api (pull request #61)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/prioritised-order-for-handlers (pull request #59)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/service-handler-setting-error-codes (pull request #58)
- **Full Commit Message:**
  ```
...
- **Commit Message:** inbound port config
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/inbound_wildfly_v11 (pull request #56)
- **Full Commit Message:**
  ```
...
- **Commit Message:** Merged in feature/version-1.0.0-beta (pull request #55)
- **Full Commit Message:**
  ```
version 1.0.0-beta
...
## [1.0.0] - 2022-05-04
- **Commit Message:** casual-caller better queue handling (#12)
- **Full Commit Message:**
  ```
...
## [0.43] - 2017-09-20
- **Commit Message:** Merged in feature/network-sync (pull request #13)
- **Full Commit Message:**
  ```
