...
public final class CorrelatorImpl implements Correlator
{
    ...
    private final Map<UUID, CompletableFuture<CasualReply>> requests = new ConcurrentHashMap<>();
    ...
    @Override
    public void put(final UUID corrid, final CompletableFuture<CasualReply> f)
    {
