...
class CasualDomainConnectReplyMessageTest extends Specification
{
    ...
    def "roundtrip message"()
    {
        ...
        when:
        CasualNWMessage<CasualDomainConnectReplyMessage> msg = CasualNetworkReader.read(sink)
        CasualNetworkWriter.write(sink, msg)
        CasualNWMessage<CasualDomainConnectReplyMessage> resurrectedMsg = CasualNetworkReader.read(sink)
        then:
        msg != null
