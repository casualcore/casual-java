...
public class CasualManagedConnection implements ManagedConnection
{
   ...
   /** The logger */
   private static Logger log = Logger.getLogger(CasualManagedConnection.class.getName());
   ...
   /** Connections */
   private Set<CasualConnectionImpl> connections;
   ...
   public CasualManagedConnection(CasualManagedConnectionFactory mcf)
   {
      ...
      this.connections = new HashSet<CasualConnectionImpl>();
   }
      ...
      ConnectionRequestInfo cxRequestInfo) throws ResourceException
   {
      ...
      CasualConnectionImpl connection = new CasualConnectionImpl(this, mcf);
   ...
   {
      log.finest("cleanup()");
      for (CasualConnectionImpl connection : connections)
      {
   ...
   {
      connections.remove((CasualConnectionImpl)handle);
