...
package se.laz.casual.jca.test.network;
...
public class InboundTest
{
    ...
    private void callEcho( )
    {
        ...
        String data = JsonProviderFactory.getJsonProvider().toJson( callDef );
        ...
        SimpleObject s1 = JsonProviderFactory.getJsonProvider().fromJson( s, SimpleObject.class );
