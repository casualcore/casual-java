...
class CasualTransactionResourcePrepareRequestMessageTest extends Specification
{
    ...
    def "Message creation"()
    {
       setup:
       when:
       def msg = CasualTransactionResourcePrepareRequestMessage.of(execution, xid, resourceId, flags)
       then:
    ...
    {
        setup:
        def requestMsg = CasualTransactionResourcePrepareRequestMessage.of(execution, xid, resourceId, flags)
