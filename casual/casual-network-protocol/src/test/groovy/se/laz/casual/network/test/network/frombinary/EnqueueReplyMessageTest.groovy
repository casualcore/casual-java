...
class EnqueueReplyMessageTest extends Specification
{
   @Shared
   def resource = '/protocol/b64/message.queue.enqueue.reply.1000.6101.b64'
   @Shared
   def resourceProtocolVersionOneThreeOrGreater = '/protocol/b64/message.queue.enqueue.reply.1003.6102.b64'
   ...
   def setupSpec()
   {
      ...
      then:
      data != null
      dataProtocolVersionOneThreeOrGreater != null
   }
