...
{
    @Shared
    def resource = '/protocol/b64/message.transaction.resource.rollback.request.1000.5205.b64'
    ...
    def "roundtrip message sync - no chunking"()
    {
        ...
        when:
        CasualNWMessageImpl<CasualTransactionResourceRollbackRequestMessage> msg = CasualNetworkTestReader.read(sink, protocolVersion)
