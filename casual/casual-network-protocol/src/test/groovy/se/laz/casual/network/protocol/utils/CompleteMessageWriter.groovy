...
class CompleteMessageWriter
{
   static def headlessMessages = [new HeadlessCasualMessage(CasualNWMessageType.DOMAIN_CONNECT_REQUEST,
           ...
           ProtocolVersion.VERSION_1_0, 'message.gateway.domain.connect.request.%d.%d.b64'),
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.DOMAIN_DISCOVERY_REPLY_V_1_4,
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.SERVICE_CALL_REQUEST_V_1_5,
                                          ...
                                          ProtocolVersion.VERSION_1_5, 'message.service.call.request.%d.%d.b64'),
                                  new HeadlessCasualMessage(CasualNWMessageType.SERVICE_CALL_REQUEST_V_1_3,
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.SERVICE_CALL_REPLY_V_1_5,
                                          '',
                                          ProtocolVersion.VERSION_1_5, 'message.service.call.reply.%d.%d.b64'),
                                  new HeadlessCasualMessage(CasualNWMessageType.SERVICE_CALL_REPLY_V_1_3,
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.ENQUEUE_REPLY_V_1_3,
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.DEQUEUE_REPLY_V_1_3,
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.CONVERSATION_CONNECT_V_1_3,
