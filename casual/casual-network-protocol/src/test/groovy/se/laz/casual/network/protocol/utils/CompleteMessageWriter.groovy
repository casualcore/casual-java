...
class CompleteMessageWriter
{
   static def headlessMessages = [new HeadlessCasualMessage(CasualNWMessageType.DOMAIN_CONNECT_REQUEST,
           ...
           ProtocolVersion.VERSION_1_0, 'message.gateway.domain.connect.request.%d.%d.b64'),
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.DOMAIN_DISCOVERY_REPLY_FROM_ONE_FOUR,
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.SERVICE_CALL_REQUEST_FROM_ONE_THREE,
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.SERVICE_CALL_REPLY_FROM_ONE_THREE,
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.ENQUEUE_REPLY_FROM_ONE_THREE,
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.DEQUEUE_REPLY_FROM_ONE_THREE,
                                  ...
                                  new HeadlessCasualMessage(CasualNWMessageType.CONVERSATION_CONNECT_FROM_ONE_THREE,
