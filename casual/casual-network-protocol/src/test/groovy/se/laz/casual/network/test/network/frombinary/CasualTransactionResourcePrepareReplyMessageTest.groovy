...
{
    @Shared
    def resource = '/protocol/bin/message.transaction.resource.prepare.Reply.1000.5202.bin'
    ...
    def "roundtrip message sync - no chunking"()
    {
        ...
        when:
        CasualNWMessageImpl<CasualTransactionResourcePrepareReplyMessage> msg = CasualNetworkTestReader.read(sink)
