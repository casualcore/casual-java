...
{
    @Shared
    def resource = '/protocol/b64/message.transaction.resource.prepare.reply.1000.5202.b64'
    ...
    def "roundtrip message sync - no chunking"()
    {
        ...
        when:
        CasualNWMessageImpl<CasualTransactionResourcePrepareReplyMessage> msg = CasualNetworkTestReader.read(sink, protocolVersion)
