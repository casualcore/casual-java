package se.kodarkatten.casual.network.protocol.decoding.decoders.service;
...
import se.kodarkatten.casual.network.protocol.messages.parseinfo.ServiceCallRequestSizes;
