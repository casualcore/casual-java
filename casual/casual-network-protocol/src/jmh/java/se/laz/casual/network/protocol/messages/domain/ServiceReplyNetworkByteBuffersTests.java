...
import se.laz.casual.network.CasualNWMessageEncoder2;
...
public class ServiceReplyNetworkByteBuffersTests
{
    public static void main(String[] args) throws RunnerException
    {
        Options opt = new OptionsBuilder()
                .include( ServiceReplyNetworkByteBuffersTests.class.getSimpleName())
                .forks(1)
                .build();
...
//            var conversationMessageHandler = ConversationMessageHandler.of( conversationMessageStorage );
            return new EmbeddedChannel( CasualNWMessageEncoder2.of() );
...
//            return channel;
        ...
        String payload = randomString( 1024000 );
