...
class FieldedHandlerTest extends Specification
{

    @Shared FieldedHandler instance
    ...
    def setup()
    {
        ...
        message = InboundRequest.of( casualServiceName, buffer.getBytes() )

        instance = new FieldedHandler( )
        ...
        jndiObject = (Proxy)Proxy.newProxyInstance(
                FieldedHandlerTest.getClassLoader(),
                c,
    ...
    def "Call Service with buffer and return result."()
    {
        ...
        FieldedTypeBuffer actual = FieldedTypeBuffer.create( reply.getPayload() )
        actual == buffer
    }
