...
public enum CasualNWMessageType
{
    ...
    DOMAIN_DISCOVERY_REPLY_V_1_4(7311),
    DOMAIN_DISCOVERY_TOPOLOGY_UPDATE(7302),
    SERVICE_CALL_REQUEST(3100),
    SERVICE_CALL_REQUEST_V_1_3(3102),
    SERVICE_CALL_REQUEST_V_1_5( 3104),
    SERVICE_CALL_REPLY(3101),
    SERVICE_CALL_REPLY_V_1_3(3103),
    SERVICE_CALL_REPLY_V_1_5(3105),
    ENQUEUE_REQUEST(6100),
    ENQUEUE_REPLY(6101),
    ENQUEUE_REPLY_V_1_3(6102),
    DEQUEUE_REQUEST(6200),
    DEQUEUE_REPLY(6201),
    DEQUEUE_REPLY_V_1_3(6202),
    ...
    CONVERSATION_CONNECT_V_1_3(3220),
