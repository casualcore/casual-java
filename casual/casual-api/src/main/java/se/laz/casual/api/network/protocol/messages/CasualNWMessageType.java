...
public enum CasualNWMessageType
{
    ...
    DOMAIN_DISCOVERY_REPLY_FROM_ONE_FOUR(7311),
    DOMAIN_DISCOVERY_TOPOLOGY_UPDATE(7302),
    SERVICE_CALL_REQUEST(3100),
    SERVICE_CALL_REQUEST_FROM_ONE_THREE(3102),
    SERVICE_CALL_REPLY(3101),
    SERVICE_CALL_REPLY_FROM_ONE_THREE(3103),
    ENQUEUE_REQUEST(6100),
    ENQUEUE_REPLY(6101),
    ENQUEUE_REPLY_FROM_ONE_THREE(6102),
    DEQUEUE_REQUEST(6200),
    DEQUEUE_REPLY(6201),
    DEQUEUE_REPLY_FROM_ONE_THREE(6202),
    ...
    CONVERSATION_CONNECT_FROM_ONE_THREE(3220),
