...
### Updates to follow JCA version 2.1.0 ([#190](https://github.com/casualcore/casual-java/issues/190))
Updated XML descriptors from Java EE to Jakarta EE:
- beans.xml: Jakarta EE 4.0 namespace
- ra.xml: Connector 2.1 namespace
...
* This fixes [#131](https://github.com/casualcore/casual-java/issues/131)

## [3.3.0] - 2024-12-10
### Feature/3.2/code needed for conversation support in casual caller ([#141](https://github.com/casualcore/casual-java/issues/141))
...
## [3.2.48] - 2024-11-28
### Bugfix/3.2/inbound discovery with custom service handlers ([#130](https://github.com/casualcore/casual-java/issues/130))

* Utilise all available ServiceHandlers to check if services are available during startup of inbound in Discover mode.

## [3.2.47] - 2024-11-21
### Bugfix/3.2/configuration mode not honoured ([#126](https://github.com/casualcore/casual-java/issues/126))
...
## [3.2.45] - 2024-10-07
### Feature/3.2/java 17 sonar fixes ([#123](https://github.com/casualcore/casual-java/issues/123))
...
## [3.2.42] - 2024-06-12
### Feature/3.2/reverse inbound share event loop group ([#118](https://github.com/casualcore/casual-java/issues/118)) ([#119](https://github.com/casualcore/casual-java/issues/119))
...
## [3.2.41] - 2024-05-15
### feature/3.2/event client do not set json object limit ([#116](https://github.com/casualcore/casual-java/issues/116))

* no user limit
* it is actually max buffer length, default is fine

## [3.2.40] - 2024-05-15
### bugfix/event client receives close in shutdown inside jvm ([#115](https://github.com/casualcore/casual-java/issues/115))
...
## [3.2.39] - 2024-05-08
### Feature/3.2/casual test ([#114](https://github.com/casualcore/casual-java/issues/114))
...
## [3.2.38] - 2024-05-02
### allow real, optional, method as well ([#112](https://github.com/casualcore/casual-java/issues/112))

* allow real, optional, method as well

## [3.2.37] - 2024-05-02
### Bugfix/3.2/log tool handle all messages ([#111](https://github.com/casualcore/casual-java/issues/111))

* handle all message types and test that we do

## [3.2.36] - 2024-04-23
### Feature/3.2/event client ([#108](https://github.com/casualcore/casual-java/issues/108))
...
## [3.2.34] - 2024-04-15
### Feature/3.2/event service testability ([#105](https://github.com/casualcore/casual-java/issues/105))
...
## [3.2.33] - 2024-03-28
### Feature/3.2/sphinx docs ([#103](https://github.com/casualcore/casual-java/issues/103))

* sphinx documentation

## [3.2.32] - 2024-03-19
### feature/3.2/metric events ([#99](https://github.com/casualcore/casual-java/issues/99))
...
## [3.2.31] - 2024-03-01
### do not run prepare, commit, rollback on netty threads ([#97](https://github.com/casualcore/casual-java/issues/97))
...
## [3.2.26] - 2023-10-19
### buggfix/3.2/pass real method to buffer handlers ([#81](https://github.com/casualcore/casual-java/issues/81))
...
## [3.2.24] - 2023-06-12
### feature/3.2/casual protocol 1.1 outbound ([#76](https://github.com/casualcore/casual-java/issues/76)) ([#77](https://github.com/casualcore/casual-java/issues/77))
...
## [3.2.22] - 2023-04-06
### name change of SPI Extension file ([#67](https://github.com/casualcore/casual-java/issues/67))
...
## [2.2.34] - 2024-10-09
### Feature/2.2/execution sticky ([#124](https://github.com/casualcore/casual-java/issues/124))
...
## [2.2.33] - 2024-09-10
### Let netty handle DNS-resolution ([#121](https://github.com/casualcore/casual-java/issues/121))
...
## [2.2.32] - 2024-06-12
### Feature/2.2/reverse inbound share event loop group ([#118](https://github.com/casualcore/casual-java/issues/118))
...
## [2.2.31] - 2024-05-06
### allow real optional method as well ([#113](https://github.com/casualcore/casual-java/issues/113))

allow real optional method as well

## [2.2.30] - 2024-04-19
### Bugfix/2.2/log tool handle all messages ([#109](https://github.com/casualcore/casual-java/issues/109))
...
## [2.2.28] - 2024-03-04
### do not run prepare, commit, rollback on netty threads ([#97](https://github.com/casualcore/casual-java/issues/97)) ([#98](https://github.com/casualcore/casual-java/issues/98))
...
## [2.2.26] - 2024-02-06
### feature/3.2/logging ([#90](https://github.com/casualcore/casual-java/issues/90))

* Log all available information in inbound message listener
* Enable setting the netty log handler level for outbound/inbound and reverse inbound

## [2.2.25] - 2023-11-16
### Buggfix/2.2/honour tpnoreply ([#83](https://github.com/casualcore/casual-java/issues/83))

A non transactional tpacall with flags TPNOREPLY should never return nor expect an answer

## [2.2.24] - 2023-10-19
### buggfix/2.2/pass real method to buffer handlers ([#82](https://github.com/casualcore/casual-java/issues/82))
...
## [2.2.22] - 2023-06-12
### Feature/2.2/casual protocol 1.1 outbound ([#76](https://github.com/casualcore/casual-java/issues/76))
...
## [2.2.19] - 2023-04-04
### casual caller external ([#66](https://github.com/casualcore/casual-java/issues/66))
...
## [2.2.18] - 2023-03-28
### wls needs Stateless annotation ([#65](https://github.com/casualcore/casual-java/issues/65))

It works fine on wildfly without the Stateless annotations but for wls that is not so.

## [2.2.17] - 2023-03-24
### Feature/make casual service handler extensible ([#63](https://github.com/casualcore/casual-java/issues/63))
...
## [2.2.16] - 2023-03-08
### Feature/maven central publishing[#17](https://github.com/casualcore/casual-java/issues/17) ([#62](https://github.com/casualcore/casual-java/issues/62))

Enable publishing to maven central, requires gpg signing key and uses manual staging release through sonar type ui.

## [2.2.15] - 2023-02-07
### Feature/stop jndi search timer if trigger mode and inbound started ([#61](https://github.com/casualcore/casual-java/issues/61))
...
## [2.2.14] - 2023-02-01
### Feature/casual xa is same rm ([#60](https://github.com/casualcore/casual-java/issues/60))

This feature solves issue [#59](https://github.com/casualcore/casual-java/issues/59) 
From the JTA spec:
...
## [2.2.13] - 2023-01-18
### Feature/discovery request names sorted and unique ([#56](https://github.com/casualcore/casual-java/issues/56))
...
## [2.2.12] - 2023-01-13
### Reduce logging from WARN to FINEST when jndi lookup fails - add exception stack. ([#55](https://github.com/casualcore/casual-java/issues/55))



## [2.2.11] - 2023-01-11
### Feature/optional inbound delay start of server ([#53](https://github.com/casualcore/casual-java/issues/53))
...
## [2.2.6] - 2022-10-25
### Feature/reverse inbound ([#42](https://github.com/casualcore/casual-java/issues/42))
...
## [2.2.5] - 2022-10-19
### Feature/jdk 8 11 17 ([#39](https://github.com/casualcore/casual-java/issues/39))

Can use jdk 8, 11 or 17 to compile.
Still going with java 8 byte code generation.

## [2.2.4] - 2022-10-14
### Feature/netty epoll ([#38](https://github.com/casualcore/casual-java/issues/38))
...
## [2.2.3] - 2022-10-12
### Feature/revert domain id ([#37](https://github.com/casualcore/casual-java/issues/37))
...
## [2.2.2] - 2022-10-10
### Feature/network pooling ([#36](https://github.com/casualcore/casual-java/issues/36))
...
## [2.1.3] - 2022-09-20
### Feature/pooling backed by randomness ([#34](https://github.com/casualcore/casual-java/issues/34))
...
## [2.0.1] - 2022-06-16
### Reduce log level from WARNING to FINEST ([#30](https://github.com/casualcore/casual-java/issues/30))



## [2.0.0] - 2022-06-08
### no optional parameter ([#27](https://github.com/casualcore/casual-java/issues/27))

Remove any Optional parameters since we do not know if they have been consumed before being passed on.

## [1.2.1] - 2022-06-02
### Feature/gradle upgrade ([#26](https://github.com/casualcore/casual-java/issues/26))

* Update gradle to 7.4.2, remove propdeps plugin, fix configurations, remove warnings.

## [1.2.0] - 2022-05-09
### Feature/test app ([#23](https://github.com/casualcore/casual-java/issues/23))
...
## [1.1.0] - 2022-05-08
### Feature/casual caller needs to handle connection reestablished better ([#21](https://github.com/casualcore/casual-java/issues/21))
